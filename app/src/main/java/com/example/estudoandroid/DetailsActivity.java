...
public class DetailsActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        UsuarioSerializable usuarioSerializable = new UsuarioSerializable("Nelmaaaaaaaa", "Sobrenome");
        outState.putSerializable("USUARIO_SERIALIZABLE", usuarioSerializable);

        UsuarioParcelable usuarioParcelable =  new UsuarioParcelable("Parcelableeeee", "Sobrenome");
